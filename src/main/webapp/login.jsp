...
<div class="easyui-window" title="学生请假系统" data-options="modal: true, closable:false, collapsible:false, minimizable:false, maximizable:false" style="width: 400px; height: 280px; padding: 10px">
	<form  id="fm"  action="" method="post">
		<table cellpadding="6px" align="center">
			...
			<tr>
				<td></td>
				<td>
					<a href="javascript:;" onclick="submitData()" class="easyui-linkbutton" iconCls="icon-submit">登录</a> &nbsp;
					<a href="javascript:;" onclick="resetValue()" class="easyui-linkbutton" iconCls="icon-reset">重置</a>
				</td>
			</tr>
		</table>
	</form>
